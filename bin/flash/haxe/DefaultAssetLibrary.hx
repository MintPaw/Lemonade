...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/info/Countries.txt", __ASSET__assets_info_countries_txt);
		type.set ("assets/info/Countries.txt", AssetType.TEXT);
...
@:keep class __ASSET__assets_info_countries_txt extends openfl.utils.ByteArray { }
...
@:file("assets/info/Countries.txt") class __ASSET__assets_info_countries_txt extends flash.utils.ByteArray {}
